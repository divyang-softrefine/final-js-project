...
},{"./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView":"l60JC","./views/resultsView.js":"cSbZE","./views/searchView.js":"9OQAM","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _utilityJs.AJAX)(`${id}?${(0, _configJs.KEY)}`);
        state.recipe = createRecipeObject(data);
        state.recipe.bookmarked = state.bookmarks.some((bookmark)=>bookmark.id === id);
    } catch (err) {
        console.error(`${err} : caught while loading recipe @ loadRecipe for id : ${id}`);
        throw err;
    }
};
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _utilityJs.AJAX)(`?search=${query}&${(0, _configJs.KEY)}`);
        ...
        console.error(`${error} thrown when fetching search results`);
        throw err;
    }
};
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _utilityJs.AJAX)(`?${(0, _configJs.KEY)}`, recipe);
        state.recipe = createRecipeObject(data);
...
},{"./config.js":"k5Hzs","./utility.js":"4CdC1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const API_URL = `https://forkify-api.herokuapp.com/api/v2/recipes/`, KEY = `key=042b9cb9-4aaa-4276-9ec1-6c1721b751f9`, RES_PER_PAGE = 10, TIMEOUT_SEC = 10, MODAL_CLOSE_SEC = 2.5;
...
},{}],"4CdC1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const AJAX = async function(input_string, uploadData) {
    const url = `${(0, _config.API_URL)}${input_string}`;
    try {
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerRender(handler) {
        [
            "hashchange",
            "load"
        ].forEach((ele)=>window.addEventListener(ele, handler));
    }
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (numPages <= 1) return ""; // Only One Page, No Pagination
        const nextMarkup = `<button data-goto="${curPage + 1}" class="btn--inline pagination__btn--next">
            <span>Page ${curPage + 1}</span>
            <svg class="search__icon">
                <use href="${(0, _iconsSvgDefault.default)}#icon-arrow-right"></use>
            </svg>
            </button>`;
        const prevMarkup = `<button data-goto="${curPage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
              <use href="${(0, _iconsSvgDefault.default)}#icon-arrow-left"></use>
            </svg>
            <span>Page ${curPage - 1}</span>
          </button>`;
        if (curPage === 1) return nextMarkup;
        else if (curPage === numPages) return prevMarkup;
        else return `${prevMarkup}${nextMarkup}`;
         // middle pages
    }
}
